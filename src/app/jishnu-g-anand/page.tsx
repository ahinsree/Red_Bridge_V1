...
export const metadata: Metadata = {
  title: "Jishnu G Anand | Digital Business Card",
  description: "Digital contact details for Jishnu G Anand, Director, Experience Practice at Red Bridge Advisory. Scan the QR code or click to save contact directly to your phone.",
  openGraph: {
    title: "Jishnu G Anand | Digital Business Card",
    description: "Director, Experience Practice at Red Bridge Advisory. Click to save contact directly or visit website.",
    url: "https://www.redbridgeadvisory.com/jishnu-g-anand",
    type: "profile",
    images: [
      {
        url: "https://www.redbridgeadvisory.com/images/jishnu-qr.png",
        width: 300,
        height: 300,
        alt: "Jishnu G Anand Contact QR Code",
      }
    ]
  }
};

export default function JishnuVCard() {
  return (
    <main className="vcard-page">
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "24px", width: "100%", maxWidth: "400px" }}>
        ...
        <div className="vcard-card">
          ...
          <h1 className="vcard-name">Jishnu G Anand</h1>
          <p className="vcard-title">Director, Experience Practice</p>

          {/* Contact details */}
          <div className="vcard-details">
            <a href="tel:+918848810766" className="vcard-detail-item">
              <span className="vcard-icon">
                <Phone size={11} />
              </span>
              <span>+91 88488 10766</span>
            </a>
        ...
        <div className="vcard-actions">
          <Link href="/jishnu-g-anand.vcf" download="jishnu-g-anand.vcf" className="vcard-btn vcard-btn--primary">
            <Download size={14} />
            Save Contact directly
          </Link>
          <a
            href="https://api.whatsapp.com/send?text=Connect%20with%20Jishnu%20G%20Anand%2C%20Director%2C%20Experience%20Practice%20at%20Red%20Bridge%20Advisory.%20View%20digital%20card%20and%20save%20contact%20directly%3A%20https%3A%2F%2Fwww.redbridgeadvisory.com%2Fjishnu-g-anand"
