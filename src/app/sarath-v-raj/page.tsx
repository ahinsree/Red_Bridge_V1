...
export const metadata: Metadata = {
  title: "Sarath V Raj | Digital Business Card",
  description: "Digital contact details for Sarath V Raj, Managing Principal at Red Bridge Advisory. Scan the QR code or click to save contact directly to your phone.",
  openGraph: {
    title: "Sarath V Raj | Digital Business Card",
    description: "Managing Principal at Red Bridge Advisory. Click to save contact directly or visit website.",
    url: "https://www.redbridgeadvisory.com/sarath-v-raj",
    type: "profile",
    images: [
      {
        url: "https://www.redbridgeadvisory.com/images/sarath-qr.png",
        width: 300,
        height: 300,
    ...
    <main className="vcard-page">
      <div className="vcard-card">
        ...
        <div className="vcard-actions">
          ...
          <a
            href="https://api.whatsapp.com/send?text=Connect%20with%20Sarath%20V%20Raj%2C%20Managing%20Principal%20at%20Red%20Bridge%20Advisory.%20View%20digital%20card%20and%20save%20contact%20directly%3A%20https%3A%2F%2Fwww.redbridgeadvisory.com%2Fsarath-v-raj"
