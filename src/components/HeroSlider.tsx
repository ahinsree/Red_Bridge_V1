...
export default function HeroSlider() {
  ...
  const slides: SlideItem[] = [
    {
      id: 0,
      tag: "Advisory & Transformation",
      headline: "Bridging Insight",
      italicWord: "to Impact.",
      sub: "World-class strategic advisory and experience transformation partner. Combining deep strategic design with raw engineering to address high-stakes enterprise bottlenecks.",
    ...
    },
    {
      ...
      sub: "Deploying secure enterprise AI frameworks backed by dynamic compliance models and real-time behavioral telemetry systems.",
    ...
    },
    {
      ...
      sub: "Eliminating operational friction and optimizing organizational velocity with continuous experience intelligence telemetry signal fabrics.",
