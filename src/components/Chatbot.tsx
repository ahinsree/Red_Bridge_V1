      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-[280px] sm:w-[320px] h-[400px] bg-[#0c101b]/70 border border-white/10 rounded-xl z-50 flex flex-col justify-between overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.6),0_0_40px_rgba(178,32,48,0.18)]"
