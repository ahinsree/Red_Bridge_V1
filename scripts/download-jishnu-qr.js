...
TITLE:Director, Experience Practice
TEL:+918848810766
...
console.log('Downloading Jishnu QR code...');
...
fetch(qrUrl)
  ...
  .then(buffer => {
    const outputPath = path.join(__dirname, '../public/images/jishnu-qr.png');
    ...
    console.log('Jishnu QR Code downloaded and saved successfully to:', outputPath);
  })
  .catch(err => {
